...
std::function<EACLOCK_Final()> EACLOCK_Final_Generator(){return defGenerator<EACLOCK_Final>();}
std::function<EACLOCK_WA()> EACLOCK_WA_Generator(){return defGenerator<EACLOCK_WA>();}
std::function<EACLOCK_DW_HR()> EACLOCK_DW_HR_generator(double hrpercent){return defGeneratorOne<EACLOCK_DW_HR>(hrpercent);}
