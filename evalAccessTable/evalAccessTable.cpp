...
// modified
        runAlgorithm("WATT", LFU_2K_E_real_Generator(KR, KW, epoch_size, randSize, randSelector, write_as_read, write_cost,
                                                       first_value, mod, Z));
        //runAlgorithm("OTHERWATT", LFU_2K_E_real_Generator(KR, KW, 2, randSize, randSelector, false, write_cost+1,0, mod, Z));
...
void EvalAccessTable::default_compare_algos() {
    ...
    runAlgorithm("EACLOCK", EACLOCK_Final_Generator());
    runAlgorithm("EACLOCK-FDW", EACLOCK_DW_HR_generator(0.3));
    runAlgorithm("EACLOCK-FWA", EACLOCK_WA_Generator());
